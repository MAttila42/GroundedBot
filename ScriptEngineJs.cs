...
/// </summary>
public sealed class ScriptEngineJs : IDisposable
{
    /// <summary>
...
public sealed class ParsedScript : IDisposable
{
    ...
    private readonly ScriptEngineJs _engine;
